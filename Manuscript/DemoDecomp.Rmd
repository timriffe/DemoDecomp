...
### Methods
Two methods are demonstrated: pseudo-continuous decomposition proposed by Horiuchi et. al. (2008) and stepwise replacement decomposition  (`stepwise_replacement()`) .
